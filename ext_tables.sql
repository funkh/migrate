#
# Table structure for table 'tx_migrate_domain_model_migration'
#
CREATE TABLE tx_migrate_domain_model_migration (
	...
	configuration_hash varchar(255) DEFAULT '' NOT NULL,
	data text NOT NULL,
	data_hash varchar(255) DEFAULT '' NOT NULL,
	data_file varchar(255) DEFAULT '' NOT NULL,
